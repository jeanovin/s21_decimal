...
START_TEST(test_sub_simple) {
  ...
  char *expected_results[] = {"-3", "-98806907", "-40008787", "-654498797",
                              "775604"};
...
START_TEST(test_sub_simple_neg) {
  s21_decimal decimal1[] = {{{775604, 0, 0, 0x80000000}},
                            {{775604, 0, 0, 0x80000000}},
                            {{775604, 0, 0, 0}}};

  s21_decimal decimal2[] = {{{56578, 0, 0, 0}},
                            {{56578, 0, 0, 0x80000000}},
                            {{56578, 0, 0, 0x80000000}}};

  char *expected_results[] = {"-832182", "-719026", "832182"};
...
START_TEST(test_sub_simple_check_code) {
  ...
  int expected_codes[] = {0, 0, 0, 0, 0, 0, 0};
...
START_TEST(test_sub_simple_float_equal_small_pow) {
  ...
  char *expected_results[] = {"-511.56", "0.44", "-58797.56", "549879.43"};
...
START_TEST(test_sub_simple_float_neg_equal_small_pow) {
  ...
  // Ожидаемые строковые результаты
  char *expected_results[] = {"-549879.67", "549879.67", "-549879.43"};
...
START_TEST(test_sub_simple_float_diff_small_pow) {
  ...
  // Ожидаемые строковые результаты
  char *expected_results[] = {"69.089874", "69.08762832"};
...
START_TEST(test_sub_decimal) {
  s21_decimal decimal1[] = {{{0b100001000, 0b1110011100, 0b10001, 0}},
  ...
  char *expected_results[] = {"-18557424799041007392455",
