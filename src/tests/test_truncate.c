...
START_TEST(test_truncate) {
  struct {
    ...
    s21_decimal truncate_dec;
      ...
      {5, {{501, 0, 0, 0x20000}}},       {5, {{571, 0, 0, 0x20000}}},
      {5, {{57185, 0, 0, 0x40000}}},     {2855, {{285500, 0, 0, 0x20000}}},
      {12, {{12741253, 0, 0, 0x60000}}}, {5, {{55, 0, 0, 0x10000}}},
      {5, {{54, 0, 0, 0x10000}}},        {5, {{56, 0, 0, 0x10000}}},
      {5, {{551, 0, 0, 0x20000}}},       {5, {{549, 0, 0, 0x20000}}},
  };
...
START_TEST(test_truncate_simple_check_code) {
  s21_decimal test_inputs[] = {
      {{1, 0, 0, 0x80000}},          {{1000000001, 0, 0, 0x80040000}},
      {{1, 0, 0, 0x20000}},          {{458741253, 0, 0, 0x80070000}},
      {{214741253, 0, 0, 0x70000}},  {{74125389, 0, 0, 0x80000}},
      {{1124574253, 0, 0, 0x80000}}, {{0, 0, 0, 0}},
      {{0, 0, 0, 0x80000}},          {{2741253, 0, 0, 0x70000}},
      {{1, 0, 0, 0x20000}}};
